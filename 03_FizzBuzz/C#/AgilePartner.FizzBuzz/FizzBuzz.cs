...
namespace AgilePartner.FizzBuzz
{
    public static class FizzBuzz
    {
        ...
        {
            new Tuple<Func<int, bool>, Func<int, string>>(n => IsNumberOutOfRange(n), (n) => throw new ArgumentOutOfRangeException("number", "Number must be greater than 0 and lower than 101")),
